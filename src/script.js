...
material.color = new THREE.Color(0x7D7D7D)
...
const pointLight2 = new THREE.PointLight(0x1fafff, 2)
pointLight2.position.set(1.14, -0.79, 1)
...
ligth1.add(pointLight2.position,'x').min(- 3).max(3).step(0.01)
ligth1.add(pointLight2.position,'y').min(- 3).max(3).step(0.01)
ligth1.add(pointLight2.position,'z').min(- 3).max(3).step(0.01)
ligth1.add(pointLight2,'intensity').min(- 3).max(10).step(0.01)

//Light3 
 
const pointLight3 = new THREE.PointLight(0x1fafff, 2)
...
light2.addColor(lightColor2,'color')
    .onChange(() =>{
...
const updateSphere = (event) => {
    sphere.position.y = window.scroll * 0.01
}
